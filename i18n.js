const translations = {
    en: {
        ...
        "schedule.tourney": "PLAYZONE",
        "schedule.wolvesden": "WOLVESDEN",
        "schedule.playoffs": "VALORANT PREMIER PLAYOFFS",
        ...
        "role.flex": "FLEX",
        "role.second_igl": "SECOND IGL",
        "role.sub_duelist": "SUB / DUELIST",
        "role.sub_smoker": "SUB / SMOKER",
        "role.sub_sentinel": "SUB / SENTINEL",
        "role.sub": "SUB",
        "about.title": "OUR PHILOSOPHY",
        "about.adapt": "ADAPTABILITY",
        "about.brotherhood": "BROTHERHOOD",
        "about.adapt_text": "Mid-round reads, map switches, counter-strategies. VINFO Esports adapts faster than the enemy can respond. Winning is a mindset, not a plan.",
        "about.brotherhood_text": "VINFO is not just a team. We are friends who compete at the highest level. The trust between us on the server translates directly into results every single match.",
        "legacy.title": "OUR LEGACY",
        "legacy.matchHistory": "RECENT MATCHES",
        "legacy.showAll": "SHOW MORE MATCHES",
        "legacy.showLess": "SHOW LESS",
        ...
        "legacy.m4": "🥈 2nd Place - 3v3 Retake LAN (€200)",
        "legacy.m6": "🏆 1st Place - VOLT Valorant Open #1",
        ...
        "tryouts.desc": "We're always scouting for exceptional talent. If you're Immortal+ and believe you can elevate VINFO to the next level, reach out. We run structured tryouts with a clear evaluation process.",
        "tryouts.req1": "Immortal 3+ or equivalent Premier rating",
        "tryouts.req2": "Fluent Czech/Slovak communication is required",
        ...
        "about.p2": "Led by our IGL Alex, we don't just play the game; we redefine the meta. From flawless executes to unbreakable site holds, the 'VINFO' operates as a single, lethal unit. Our eyes are set on the highest tiers of European Valorant, and we won't stop until we reach the top.",
        ...
        "phil.prec": "PRECISION",
        "phil.prec_desc": "Every util, every smoke, every push is deliberate. Alex's IGL calls are crafted from hours of VOD review and strategic preparation against every opponent.",
        ...
        "trophy.volt": "VOLT OPEN<br>#1",
        "trophy.score_volt": "FINAL SCORE: 2-0",
        "trophy.vs_volt": "vs. N2xt valorant",
        "trophy.tmvp_volt": "Team MVP",
        "faq.q01": "Are you looking for new players?",
        "faq.a01": "Our core roster is currently locked in for the upcoming matches. However, we always keep an eye out for exceptional High Immortal/Radiant talent to join VINFO Esports as substitutes or for the practice squad.",
        "faq.q02": "Who does the in-game calling?",
        "faq.a02": "Alex is our dedicated IGL (In-Game Leader), orchestrating the mid-round calls, utility combinations, and overall match strategy.",
        "faq.q03": "How often do you practice?",
        "faq.a03": "We play official Premier matches weekly and run internal scrims against other top-tier teams 3-4 times a week to stay sharp.",
        ...
        "scrim.desc": "We're always looking to challenge ourselves against other top-tier and Radiant-level teams. If you think your roster can handle VINFO Esports, reach out and let's run it.",
        ...
        "support.desc": "We're a self-funded team grinding our way to the top. Every donation helps us cover tournament fees, equipment, and keeps VINFO Esports running. Every single cent goes back into making VINFO better.",
        "support.btn1": "DONATE NOW ❤️",
        "support.btn2": "JOIN DISCORD",
        "footer.desc": "VINFO Esports — Czech Valorant squad competing in Premier. Join VINFO Esports on our journey to Challengers.",
        ...
        "faq.a3": "Our primary objective is to dominate the Premier division and fight our way into the Challengers league through Ascension.",
        ...
        "faq.q5": "How can I support VINFO Esports?",
        "faq.a5": "The best way to support us right now is by joining our Discord, following our socials, and cheering for us in stream chats during match days. You can also support the team directly by <a href=\"https://streamlabs.com/gczdejwrix/tip\" target=\"_blank\" style=\"color: var(--val-red); text-decoration: underline; font-weight: bold;\">donating here</a>. Merch is also dropping soon!",
        ...
        "schedule.vsvitality": "VINFO vs. Team Vitality",
    ...
    cz: {
        ...
        "about.adapt_text": "Čtení hry, rychlé změny mapy, counter-stratování. Naše VINFO se přizpůsobí rychleji, než nepřítel zareaguje. Výhra není plán, ale nastavení mysli.",
        "about.brotherhood_text": "VINFO není jen tým. Jsme přátelé, co hrají na nejvyšší úrovni. Důvěra mezi námi na serveru se odráží ve výsledku každého jednoho zápasu.",
        "legacy.title": "NAŠE HISTORIE",
        "legacy.matchHistory": "ZÁPASY Z PREMIER A TURNAJŮ",
        "legacy.showAll": "ZOBRAZIT DALŠÍ ZÁPASY",
        "legacy.showLess": "ZOBRAZIT MÉNĚ",
        "legacy.milestones": "ÚSPĚCHY A CÍLE",
        "legacy.m1": "🏆 1. Místo - Re ignite Turnaj",
        "legacy.m2": "🏆 1. Místo - Playzone Turnaj",
        "legacy.m3": "🥇 1. Místo - Wolvesden Turnaj",
        "legacy.m4": "🥈 2. Místo - 3v3 Retake LAN (200€)",
        "legacy.m6": "🏆 1. Místo - VOLT Valorant Open #1",
        ...
        "tryouts.desc": "Neustále hledáme výjimečné talenty. Pokud jsi Immortal+ a věříš, že dokážeš posunout VINFO na další úroveň, ozvi se. Nabízíme strukturované tryouty s jasným procesem hodnocení.",
        "tryouts.req1": "Immortal 3+ nebo ekvivalentní Premier rank",
        "tryouts.req2": "Plynulá čeština/slovenština je podmínkou",
        ...
        "about.p2": "Pod vedením našeho IGL Alexe hru nejen hrajeme, my utváříme metu. Od bezchybných executů po neprolomitelné držení sajtů, 'VINFO' funguje jako jediná, smrtící jednotka. Náš zrak se upírá na ty nejvyšší vrstvy evropského Valorantu a nezastavíme se, dokud nebudeme na vrcholu.",
        ...
        "phil.prec": "PŘESNOST",
        "phil.prec_desc": "Každá utilita, každý smoke, každý push je úmyslný. Alexovy IGL cally jsou vytvořeny z hodin VOD reviews a strategické přípravy proti každému soupeři.",
        "stream.title": "LIVESTREAM",
        ...
        "trophy.volt": "VOLT OPEN<br>#1",
        "trophy.score_volt": "FINÁLNÍ SKÓRE: 2-0",
        "trophy.vs_volt": "vs. N2xt valorant",
        "trophy.tmvp_volt": "MVP Týmu",
        "faq.q01": "Hledáte nové hráče?",
        "faq.a01": "Naše hlavní sestava je pro nadcházející zápasy aktuálně uzamčena. Vždy však hledáme výjimečné High Immortal/Radiant talenty, které by se k nám přidaly jako náhradníci nebo do practice squadu.",
        "faq.q02": "Kdo dělá herní cally?",
        "faq.a02": "Alex je náš dedikovaný IGL (In-Game Leader), který orchestruje cally uprostřed kola, kombinace utilit a celkovou strategii zápasu.",
        "faq.q03": "Jak často trénujete?",
        "faq.a03": "Oficiální Premier zápasy hrajeme týdně a hrajeme interní scrimy proti ostatním špičkovým týmům 3-4krát týdně, abychom zůstali ostří.",
        ...
        "scrim.desc": "Vždy hledáme výzvy proti ostatním špičkovým a Radiant týmům. Pokud si myslíte, že vaše sestava zvládne VINFO, ozvěte se a pojďme hrát.",
        ...
        "support.desc": "Jsme samofinancovaný tým, který se dře na vrchol. Každý příspěvek nám pomáhá pokrýt poplatky za turnaje, vybavení a udržuje VINFO v běhu. Každý cent jde zpět do toho, aby byl VINFO lepší.",
        "support.btn1": "PŘISPĚT ❤️",
        "support.btn2": "PŘIPOJIT SE NA DISCORD",
        "footer.desc": "VINFO Esports — Česká Valorant sestava soutěžící v Premier. Přidej se ke VINFO na naší cestě do Challengers.",
        ...
        "faq.a3": "Naším hlavním cílem je dominovat v Premier divizi a probojovat se do ligy Challengers skrz Ascension.",
        ...
        "faq.q5": "Jak můžu VINFO Esports podpořit?",
        "faq.a5": "Nejlepší způsob, jak nás podpořit, je připojit se na náš Discord, sledovat naše sítě a fandit na streamech. Tým můžete přímo podpořit také <a href=\"https://streamlabs.com/gczdejwrix/tip\" target=\"_blank\" style=\"color: var(--val-red); text-decoration: underline; font-weight: bold;\">donatem zde</a>. Brzy navíc vyjde i oficiální merch!",
