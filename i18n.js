const translations = {
    en: {
        ...
        "about.p1": "GCZ is a premier Valorant team built on aggressive plays, tactical superiority, and an unbreakable bond. Formed by a group of High Immortal and Radiant prodigies, our journey started in local competitive ladders. We are dominating the scene with our unique, fearless playstyle.",
        "about.p2": "Led by our IGL Fanta, we don't just play the game; we redefine the meta. From flawless executes to unbreakable site holds, the 'Herd' operates as a single, lethal unit. Our eyes are set on the highest tiers of European Valorant, and we won't stop until we reach the top.",
        ...
        "phil.prec": "PRECISION",
        "phil.prec_desc": "Every util, every smoke, every push is deliberate. Fanta's IGL calls are crafted from hours of VOD review and strategic preparation against every opponent.",
        ...
        "faq.a01": "Our core roster is currently locked in for the upcoming matches. However, we always keep an eye out for exceptional High Immortal/Radiant talent to join the herd as substitutes or for the practice squad.",
        "faq.q02": "Who does the in-game calling?",
        "faq.a02": "Fanta is our dedicated IGL (In-Game Leader), orchestrating the mid-round calls, utility combinations, and overall match strategy.",
        ...
        "scrim.desc": "We're always looking to challenge ourselves against other top-tier and Radiant-level teams. If you think your roster can handle the Herd, reach out and let's run it.",
        ...
        "support.desc": "We're a self-funded team grinding our way to the top. Every donation helps us cover tournament fees, equipment, and keeps the herd running. Every single cent goes back into making GCZ better.",
        "support.btn1": "DONATE NOW ❤️",
        "support.btn2": "JOIN DISCORD",
        "footer.desc": "GCZ Esports — International Valorant squad competing in Premier. Join the herd on our journey to Challengers.",
    ...
    cz: {
        ...
        "about.title": "STÁDO",
        "about.p1": "GCZ je elitní Valorant tým postavený na agresivních plays, taktické převaze a nezlomném poutu. Jsme složeni ze skupiny High Immortal a Radiant hráčů a naše cesta začala v kompetitivních žebříčcích. Dominujeme scéně s naším unikátním a nebojácným stylem hry.",
        "about.p2": "Pod vedením našeho IGL Fanty hru nejen hrajeme, my utváříme metu. Od bezchybných executů po neprolomitelné držení sajtů, 'Stádo' funguje jako jediná, smrtící jednotka. Náš zrak se upírá na ty nejvyšší vrstvy evropského Valorantu a nezastavíme se, dokud nebudeme na vrcholu.",
        ...
        "phil.prec": "PŘESNOST",
        "phil.prec_desc": "Každá utilita, každý smoke, každý push je úmyslný. Fantovy IGL cally jsou vytvořeny z hodin VOD reviews a strategické přípravy proti každému soupeři.",
        "stream.title": "LIVESTREAM",
        ...
        "faq.a02": "Fanta je náš dedikovaný IGL (In-Game Leader), který orchestruje cally uprostřed kola, kombinace utilit a celkovou strategii zápasu.",
        ...
        "scrim.desc": "Vždy hledáme výzvy proti ostatním špičkovým a Radiant týmům. Pokud si myslíte, že vaše sestava zvládne Stádo, ozvěte se a pojďme hrát.",
        ...
        "support.desc": "Jsme samofinancovaný tým, který se dře na vrchol. Každý příspěvek nám pomáhá pokrýt poplatky za turnaje, vybavení a udržuje stádo v běhu. Každý cent jde zpět do toho, aby byl GCZ lepší.",
        "support.btn1": "PŘISPĚT ❤️",
        "support.btn2": "PŘIPOJIT SE NA DISCORD",
        "footer.desc": "GCZ Esports — Mezinárodní Valorant sestava soutěžící v Premier. Přidej se ke stádu na naší cestě do Challengers.",
