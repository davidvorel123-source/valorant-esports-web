const translations = {
    en: {
        ...
        "news.date1": "MAY 23, 2026",
        "news.title1": "TEZZY & WOODY JOIN AS SUBS",
        "news.desc1": "We are thrilled to welcome Tezzy and Woody to the herd as our official substitutes. Their flexibility and firepower will be a massive asset to our Contender run.",
        "news.date2": "MAY 22, 2026",
        "news.title2": "ROSTER LOCKED IN",
        "news.desc2": "The new Goats CZ roster is officially locked in for the upcoming season. Weeks of tryouts and intense practice have forged a deadly core ready to dominate.",
    ...
    cz: {
        ...
        "news.title": "NOVINKY",
        "news.date1": "23. KVĚTNA 2026",
        "news.title1": "TEZZY & WOODY SE PŘIPOJUJÍ JAKO NÁHRADNÍCI",
        "news.desc1": "S nadšením vítáme Tezzyho a Woodyho ve stádě jako naše oficiální náhradníky. Jejich flexibilita a palebná síla budou obrovským přínosem pro náš boj v Contender divizi.",
        "news.date2": "22. KVĚTNA 2026",
        "news.title2": "ROSTER JE UZAVŘEN",
        "news.desc2": "Nový Goats CZ roster je oficiálně uzavřen pro nadcházející sezónu. Týdny tryoutů a intenzivních tréninků vykovaly vražedné jádro připravené dominovat.",
